...
import st.domain.ggviario.secret.dao.DaoClient;
import st.domain.ggviario.secret.model.Client;
import st.domain.ggviario.secret.model.visitor.SellCollectorVisitor;
import st.domain.ggviario.secret.model.builders.ClientBuilder;
import st.domain.ggviario.secret.references.RMap;
import st.domain.ggviario.secret.util.animator.OnAnimateSelection;
import st.domain.ggviario.secret.util.animator.Selectable;
import st.domain.ggviario.secret.NewClientActivity;
import st.domain.ggviario.secret.support.adapters.SupportAdapter;
import st.domain.ggviario.secret.support.adapters.vfactory.ClientViewHolderFactory;
import st.domain.ggviario.secret.support.adapters.dataset.ClientDataSet;
import st.domain.ggviario.secret.model.visitor.Collectable;
import st.domain.ggviario.secret.support.callbaks.OnActivityResultObserver;
