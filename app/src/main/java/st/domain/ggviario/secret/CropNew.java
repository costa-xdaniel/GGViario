...
import st.domain.ggviario.secret.support.SectorAdapter;
...
import st.domain.ggviario.secret.support.events.MenuObserver;
...
public class CropNew extends AppCompatActivity
{
    Toolbar toolbar;
