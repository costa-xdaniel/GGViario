...
import st.domain.ggviario.secret.util.animator.SelectableAnimatorManager;
import st.domain.ggviario.secret.util.animator.SelectableTextViewAnimatorManager;
import st.domain.ggviario.secret.support.adapters.dataset.ClientDataSet;
import st.domain.ggviario.secret.support.adapters.ClientViewHolder;
