...
import st.domain.ggviario.secret.model.Sell;
...
import static st.domain.ggviario.secret.references.RData.ALL;
import static st.domain.ggviario.secret.references.RData.DATABASE_NAME;
import static st.domain.ggviario.secret.references.RData.DATABASE_VERSION;
import static st.domain.ggviario.secret.references.RData.REQ_BASEQUANTITY;
import static st.domain.ggviario.secret.references.RData.REQ_CLI_ID;
import static st.domain.ggviario.secret.references.RData.REQ_DTENTREGA;
import static st.domain.ggviario.secret.references.RData.REQ_DTPAGAR;
import static st.domain.ggviario.secret.references.RData.REQ_MET_ID;
import static st.domain.ggviario.secret.references.RData.REQ_MONTPAYMENT;
import static st.domain.ggviario.secret.references.RData.REQ_PREVIEWID;
import static st.domain.ggviario.secret.references.RData.REQ_PROD_ID;
import static st.domain.ggviario.secret.references.RData.REQ_QUANTITY;
import static st.domain.ggviario.secret.references.RData.REQ_TREQ_ID;
import static st.domain.ggviario.secret.references.RData.REQ_USER_ID;
import static st.domain.ggviario.secret.references.RData.SELL_PRICE;
import static st.domain.ggviario.secret.references.RData.T_REQUEST;
import static st.domain.ggviario.secret.references.RData.VER_OPERATION_DAY;
