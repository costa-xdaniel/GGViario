...
public class CropChartLineViewHolder extends ItemViewHolder {
    ...
    public CropChartLineViewHolder(View itemView) {
        super(itemView);
    ...
    @Override
    public void onBind(ItemDataSet dataSet, int currentPosition, int totalDataSet) {
        ...
        ListOperation<CropChartSectorViewHolder.CropChartSectorDataSet> listOperation = new ListOperation(list);
        listOperation.sortDesc(new Comparator<CropChartSectorViewHolder.CropChartSectorDataSet>() {
            @Override
            public int compare(CropChartSectorViewHolder.CropChartSectorDataSet o1, CropChartSectorViewHolder.CropChartSectorDataSet o2) {
    ...
    public static class ChartDataSet implements ItemDataSet {
        ...
        public List<ItemDataSet> getLegendDescription(){
            ...
            for (ChartDataLine line: this.datas) {
                list.add(new CropChartSectorViewHolder.CropChartSectorDataSet(line.colorId, line.sector, line.totalQuantity));
            }
            return list;
        }
